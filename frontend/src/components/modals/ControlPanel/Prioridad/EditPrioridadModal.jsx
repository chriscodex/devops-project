...
function EditPrioridadModal(props) {
  const { loadPrioridades, prioridadItem, prioridadId } = props;
  const { updatePrioridad } = useOrden();
  ...
  const handleSaveButton = async () => {
    try {
      ...
      await updatePrioridad(prioridadId, { prioridad: inputValue });
      Swal.fire({
        position: 'center',
        icon: 'success',
