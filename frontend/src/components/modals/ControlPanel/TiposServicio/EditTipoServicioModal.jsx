...
function EditTipoServicioModal(props) {
  const { loadItems, itemName, itemId } = props;
  const { updateTipoServicio } = useOrden();
  ...
  const handleSaveButton = async () => {
    try {
      ...
      await updateTipoServicio(itemId, { tipoServicio: inputValue });
      Swal.fire({
        position: 'center',
        icon: 'success',
